...
/// Version 3 introduces document splitting: Root + Collection + ThingMarkdown
...
impl Schema {
    ...
    pub fn init_thing_markdown_doc(actor: &str, thing_uuid: &str) -> Result<Vec<u8>> {
        ...
        put_string(&mut doc, &content, "kind", "markdown")?;
    ...
    pub fn detect_doc_type(doc_bytes: &[u8]) -> Result<Option<CrdtDataType>> {
        ...
        // Check for ThingMarkdown document marker (thing_uuid + content)
