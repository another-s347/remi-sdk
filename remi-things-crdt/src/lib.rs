...
pub use extract::{
	...
	extract_thing_markdown_view, extract_thing_markdown_view_from_doc,
};
...
// V3 views
pub use view::{RootView, CollectionDocView, CollectionMetaView, ThingMetaView, ThingBuiltInFieldsView, ThingMarkdownView};
// V3 compaction
pub use compaction::{
    needs_compaction, DEFAULT_COMPACTION_THRESHOLD,
    compact_root_doc, compact_collection_doc, compact_thing_markdown_doc,
};
